                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/<?php echo $product['product_image']; ?>" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a href="add-to-cart.php?id=<?php echo $product['id']?>" class="btn btn-primary px-3" role="button" ><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</a>
                    </div>
