...
<head>
    <meta charset="utf-8">
    <title>Beauty Palace-Cosmetic</title>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4" >
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100"style="height:300px; width:300px;"  src="img/<?php echo $row[4] ?>" alt="">
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="detail.php?id=<?php echo $row[0]?>"><?php echo $row[4] ?></a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$<?php echo $row[0] ?></h5><h6 class="text-muted ml-2"><del>$<?php echo $row[0] ?></del></h6>
                                </div>
