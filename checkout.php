                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Name</label>
                            <input class="form-control" name="name" type="text" placeholder="Full Name (John)">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                        ...
                        <div class="col-md-6 form-group">
                            <label>Cell No</label>
                            <input class="form-control" name="cell" type="text" placeholder="+123 456 789">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Birth Date</label>
                            <input class="form-control" name="birth" type="date" placeholder="y-m-d">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <button class="btn btn-warning" name="submit"> Place Order</button>
                    </div>
                </div>
                </form>
...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO `orders`(`id`,`name`, `email`, `address`,  `phone`, `cell`, `birth`, `category`) VALUES ('null','$name','$email','$address','$phone','$cell','$birth','$category')";
